...
# Check for existing standard fold IDs to ensure consistency across different model notebooks
fold_path = f'{DATA_DIR}/fold_ids.csv'
if os.path.exists(fold_path):
    print("--- Loading existing fold IDs ---")
    ...
    # Save the IDs so your XGB and CatBoost notebooks can use the exact same splits
    train[[ID, 'fold']].to_csv(fold_path, index=False)

# =========================================================================================
# 3. PREPROCESSING
# =========================================================================================
# LightGBM handles 'object' columns automatically if they are cast to 'category'
...
for fold in range(N_SPLITS):
    ...
    # Initialize Model (Using basic params, tune these later!)
...
print(f"✅ Saved OOFs to /{OOF_DIR} and submission to /{SUB_DIR}")